...
function Hero(){
    ...
    <div>
        <div className="min-h-screen w-100v absolute">
            ...
            <video src="https://taherpatrawala-drinkly.netlify.app/src/video/video.mp4" autoPlay loop muted className="object-cover h-100v w-full object-center"/>

        </div>
        <div className="text-6xl min-h-screen">iudhfpieufh</div>
