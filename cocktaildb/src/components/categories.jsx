        ...
        <div className="min-h-screen">
            <div className="min-h-screen w-full bg-black grid esm:grid-cols-2 esm:gap-2 md:grid-cols-3 md:gap-4 p-6">
                ...
                <p className="text-3xl text-white absolute bottom-4 left-2">Martini</p>   
                    ...
                    <div className="h-full w-full  group-hover:scale-125 group-hover:opacity-40 transition-all" 
                        ...
                        <div className="opacity-0 group-hover:opacity-100 absolute h-full w-full
                 ...
                 <div className=" overflow-hidden relative">
                      <p className="text-3xl text-white absolute bottom-4 left-2">Martini</p>   
                      <div className="h-full w-full group">
                    <div className="h-full w-full  hover:scale-125   group-hover:scale-125 group-hover:opacity-40 transition-all" 
                    style={{backgroundImage:"url('/src/components/assets/video/images/margarita-cocktail.jpg')",
                                                      backgroundSize:"cover",
                                                      backgroundPosition:"center",
                                                      backgroundRepeat:"no-repeat"}}>
