    ...
    return (
        <div className="w-100v z-50 bg-transparent sticky top-0 transition-all duration-700">
            <div className="flex justify-between p-3   items-center bg-transparent">
              ...
              <NavLink to="/popular" className="m-3 ">Popular</NavLink>
              <NavLink to="/about" className="m-3 ">About us</NavLink>
              <NavLink to="/fav" className="m-3 ">Favourite</NavLink>
              <NavLink to="/cart" className="m-3 ">Cart</NavLink>
            </nav>
